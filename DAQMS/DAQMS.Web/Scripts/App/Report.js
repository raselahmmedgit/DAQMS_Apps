function GetUrl() {
    ...
    var url = '/Report/GetTempLineChartListAjax?companyId=' + companyId + '&projectId=' + projectId + '&deviceId=' + deviceId + '&dateRangeFrom=' + dateRangeFrom + '&dateRangeTo=' + dateRangeTo + '&valueType=' + valueType + '&sensor=' + sensor;

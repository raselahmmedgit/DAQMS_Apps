...
namespace DAQMS.Web.Controllers
{
    public class ModuleController : Controller
    {
        ...
        {
            IList<ModuleViewModel> model = _moduleService.GetAll();
            return PartialView("_PartialList", model);
        }

        [AcceptVerbs(HttpVerbs.Post)]
        public PartialViewResult List(int? page, ModuleViewModel model)
        {
            IList<ModuleViewModel> data = _moduleService.GetByItem(model);
        ...
        public ActionResult Create(ModuleViewModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        returnId = _moduleService.InsertData(model);
        ...
        {
            ModuleViewModel model = _moduleService.GetIById(id);
            return View(model);
        }
        ...
        public ActionResult Edit(ModuleViewModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (string.IsNullOrEmpty(strMessage))
                    {
                        returnId = _moduleService.UpdateData(model);
        ...
        public JsonResult DeleteConfirmed(int id)
        {
            ...
            try
            {
                ...
                userId = _moduleService.DeleteData(id);
